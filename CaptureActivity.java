...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
    ...
    resultView = findViewById(R.id.result_view);
      ...
      tospeech = new TextToSpeech(this, new TextToSpeech.OnInitListener(){
          ...
          public void onInit(int i) {
              if(i == TextToSpeech.SUCCESS) result = tospeech.setLanguage(Locale.UK);
              else{
                  Toast.makeText(getApplicationContext(), "Feature Unsupport", Toast.LENGTH_SHORT).show();
              }
          }
      });
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
    ...
    tospeech.speak(ocrResultTextView.getText().toString(), TextToSpeech.QUEUE_FLUSH,null);
